namespace _03.PublishToDropBox
{
    using Spring.IO;
    ...
    class Startup
    {
        ...
        private const string DropboxAppKey = "q2dmdkunvm3v83w";
        private const string DropboxAppSecret = "ds17bbth9tzy7fk";
        ...
        static void Main()
        {
            ...
            Entry uploadFileEntry = dropbox.UploadFileAsync(
                new FileResource("../../Batman.jpg"),
                "/" + newFolderName + "/Batman.jpg").Result;
